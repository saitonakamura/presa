...
type Props = Pick<
  ConnectedState,
  'currentSlide' | 'presentationName' | 'slides' | 'switchSlide'
> &
  Stylable

class Toc extends React.Component<Props> {
  _tocEl: HTMLElement | null = null
...
const SlideItem = styled.div<{ current: boolean; future: boolean }>`
  margin-bottom: 5px;
  cursor: pointer;
  color: #666;
  padding: 5px 0;
